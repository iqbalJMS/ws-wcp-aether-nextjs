  ...
  return (
    <div ref={elementRef} className={[
      ...
      active ? 'visible' : 'invisible'
        ...
        <div className="absolute top-2 right-4 text-lg cursor-pointer" onClick={() => setActive(false)}>close</div>
      <div className="py-20 container">
        <div className="pb-10 border-b border-black">
          <div className="text-center text-2xl font-semibold mb-5">Temukan yang Anda Butuhkan</div>
          <div className="text-center">
            <div className="border border-black rounded-full inline-flex items-center overflow-hidden px-5 py-2 w-[60%]">
              ...
              <div><svg className="w-7 h-7" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="m19.485 20.154l-6.262-6.262q-.75.639-1.725.989t-1.96.35q-2.402 0-4.066-1.663T3.808 9.503T5.47 5.436t4.064-1.667t4.068 1.664T15.268 9.5q0 1.042-.369 2.017t-.97 1.668l6.262 6.261zM9.539 14.23q1.99 0 3.36-1.37t1.37-3.361t-1.37-3.36t-3.36-1.37t-3.361 1.37t-1.37 3.36t1.37 3.36t3.36 1.37"/></svg></div>
            </div>
          </div>
        </div>
        <div>
          <CE_TabMain list={[{title:'PRODUK', slug: 'pro'}, {title:'BERITA', slug: 'ber'}]} value="pro" variant="full" onChange={() => {}}/>
        </div>
        <div>
          {/* RESULT */}
          <div className="text-center py-20">
            <div className="text-2xl font-bold">Tidak dapat menemukan <span className="text-red-01">apa yang kalian cari?</span></div>
            <div>Carilah jawaban pada <Link className="underline font-semibold" href={'https://bri.co.id/web/bri/bantuan'}>halaman FAQ</Link> atau arahkan ke kategori konten berikut</div>
          </div>
          <div>
...
export function LoginButton() {
  ...
  return (
    ...
    >
      <div>Login</div>
      <div className="pl-2"><svg className="w-5 h-5"  width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M7.41 8.58L12 13.17l4.59-4.59L18 10l-6 6l-6-6z"/></svg></div>
      <div className={[
        ...
        {logins.map((loginItem, index) => {
          return (
            <div key={index} className="w-full bg-white mb-2 px-5 py-4 rounded-3xl">
              <Link href={loginItem.link} target="_blank">
                <div className={`flex items-center  text-${loginItem.color}`}>
                  <div className="mr-2"><svg className="w-6 h-6" width="32" height="32" viewBox="0 0 256 256"><path fill="currentColor" d="M216 56h-40v-8a24 24 0 0 0-24-24h-48a24 24 0 0 0-24 24v8H40a16 16 0 0 0-16 16v128a16 16 0 0 0 16 16h176a16 16 0 0 0 16-16V72a16 16 0 0 0-16-16M96 48a8 8 0 0 1 8-8h48a8 8 0 0 1 8 8v8H96Zm120 24v41.61A184 184 0 0 1 128 136a184.1 184.1 0 0 1-88-22.38V72Zm0 128H40v-68.36A200.2 200.2 0 0 0 128 152a200.25 200.25 0 0 0 88-20.37zm-112-88a8 8 0 0 1 8-8h32a8 8 0 0 1 0 16h-32a8 8 0 0 1-8-8"/></svg></div>
                ...
                return (
                  <div key={index}>
                    <div 
                      ...
                      onClick={() => header.title.toLowerCase() === 'cari' ? setActiveSearch(true) : false}
                    >
                      {header.icon && (
                        <Image
                          extern
