...
export default function GlobalHeader() {
    ...
    return (
        <>
            <header
                className={`${isScrolling ? "shadow-md" : "shadow-md"} relative`}
            >
                <div className="container py-5 ">
                    <div className="flex items-center gap-5 justify-end mb-5">
                        ...
                        <div className="flex items-center gap-5 text-sm">
                            <div className="px-2 py-1 border border-orange-01 rounded-md">ID</div>
                            <div>EN</div>
                        </div>
                    </div>
                        ...
                        <div>
                            <div className="flex items-center gap-10 ">
                                {headerBottoms.map((headerBottom, index) => {
                                    return (
                                        <div key={index} className="pb-2 group border-b-4 border-transparent hover:border-red-01 ">
                                            <div className="text-lg font-semibold cursor-pointer">{headerBottom.title}</div>
                                            <div className="absolute left-0 w-full  hidden group-hover:block pt-10 ">
                                                <div className="bg-white border">
                                                    <div className="container py-5">
                                                        <div className="text-2xl mb-3 font-bold">{headerBottom.title}</div>
                                                        <div className="flex ">
                                                            {headerBottom.subs.map((subItem, subIndex) => {
                                                                return (
                                                                    <div key={subIndex} className="mr-40" >
                                                                        <div className="text-red-01 font-semibold">{subItem.title}</div>
                                                                        <div>
