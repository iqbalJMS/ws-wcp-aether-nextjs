...
export function CE_IconMain({ maxListShow = 1, list: initialList, cookiesName }: T_IconMainProps) {
                  ...
                  <div key={listIndex} className="w-1/4 px-2 mb-4 h-full">
                    <div onClick={() => handleChooseMenu(listIndex)} className="relative">
                      <div className="absolute -top-2 -right-2 z-10">
                        {listItem.active ? 
                          (<svg className="text-red-01" width="32" height="32" viewBox="0 0 256 256"><path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.11 104.11 0 0 0 128 24m40 112H88a8 8 0 0 1 0-16h80a8 8 0 0 1 0 16"/></svg>) : 
                          (<svg 
                            className={[isMaxActiveList ? "text-gray-200" : "text-blue-01"].join(' ')} 
                            width="32" height="32" viewBox="0 0 256 256"><path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.13 104.13 0 0 0 128 24m40 112h-32v32a8 8 0 0 1-16 0v-32H88a8 8 0 0 1 0-16h32V88a8 8 0 0 1 16 0v32h32a8 8 0 0 1 0 16"/></svg>)
                        }
