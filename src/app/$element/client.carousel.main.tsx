...
export function CE_CarouselMain({
  ...
  return (
    <>
      ...
      {variant === '04' && (
        <CE_CarouselVariant04 data={data} title={title} button={button} description={description} />
      )}
      {variant === '05' && (
        <CE_CarouselVariant05 data={data} title={title} button={button} description={description} />
      )}
    </>
  );
}
