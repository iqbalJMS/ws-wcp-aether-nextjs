          ...
          <div className="w-[20%] mdmax:w-full flex-none">
            ...
            {button && (
              <Link href={button?.link} target="_blank">
                <div className="inline-flex gap-2 items-center text-blue-01 mt-4">{parseHTMLToReact(button?.name || '')} <span className="text-xs">&#10095;</span></div>
              </Link>
            )}
          </div>
                ...
                <div key={index} className="w-1/4 mdmax:w-1/2 flex-none px-2">
                  <Link href={dataItem.button?.link || ''} target="_blank">
                    <div className="p-4 mdmax:p-2 shadow-lg">
                      ...
                      <div>
                        <div className=" text-red-01 font-semibold mb-2">{parseHTMLToReact(dataItem.title)}</div>
